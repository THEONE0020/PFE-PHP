  ...
  <body>
    <div>
               ...
               <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm px-5 py-3 py-lg-0 sticky-top">
                <a href="DirecteurHome.html" class="navbar-brand p-0">
      ...
      <div class="etud-list position-absolute">
        <h1><span> Liste des étudiants</span></h1>
      ...
      <tr>
        ...
        <div class="back-circle" onclick="back3()">
            <i class="fa-solid fa-left-long fa-2xl" style="color: #ffffff;"></i>
                </div>
        </div>
      </div>
      <a class="btn-ajt" href="ad_etudiant.html"><i class="fa-solid fa-user-plus" style="color: #fcfdfe;"></i> Add student</a>
               <!-- Footer Start -->
         <!-- <br><br> -->
