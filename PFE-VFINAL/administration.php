               ...
               <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm px-5 py-3 py-lg-0  sticky-top">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0 me-n3">
                        <a href="administration.html" class="nav-item nav-link active">Home</a>
        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="imgs/Administrator-bg.jpg" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3 car-text" style="max-width: 900px;">
                            <h5 class="text-white1 text-uppercase">Bienvenue Azze-el arab Bouferdou à </h5>
                            <h1 class="display-1 text-white mb-md-4">Votre espace </h1>
                            <a href="" class="btn btn-primary py-md-3 px-md-5 me-3 rounded-pill">Forum</a>
